    ...
    try {
      ...
      const subscriptionResponse = await fetch("/api/subscriptions", {
        ...
        body: JSON.stringify({
          ...
          status: "active",
          billingCycleMonths,
          billingCycle: billingCycleMonths === 1 ? "monthly" : billingCycleMonths === 6 ? "semi_annual" : "yearly",
      ...
      const cycleLabel = billingCycleMonths === 1 ? "Monthly" : billingCycleMonths === 6 ? "6 Months" : "Yearly";
