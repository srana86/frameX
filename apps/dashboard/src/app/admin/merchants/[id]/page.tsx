...
export default function MerchantDetailPage({
  ...
  const loadData = async () => {
    setLoading(true);
    try {
      const merchantData = await api.get<MerchantFull>(
        `merchants/${resolvedParams.id}/full`
      );
      ...
      toast.error(error?.message || "Failed to load merchant details");
    } finally {
      setLoading(false);
    }
  };
  ...
  const handleDelete = async () => {
    if (
      !confirm(
        "Are you sure you want to delete this merchant and all associated data? This action cannot be undone."
      )
    ) {
      return;
    }
    ...
    try {
      await api.delete(`merchants/${resolvedParams.id}`);
          ...
          <div className="grid gap-6 lg:grid-cols-2">
            ...
            <Card>
              ...
              <CardContent className="grid gap-4 sm:grid-cols-2">
                <InfoItem
                  label="Merchant ID"
                  value={<code className="text-xs">{merchant.id}</code>}
                />
            ...
            <CardContent>
              {subscription && plan ? (
                ...
                <div className="flex flex-col items-center justify-center py-12 text-center">
                  ...
                  <p className="text-sm text-muted-foreground">
                    This merchant doesn&apos;t have an active subscription
                  </p>
            ...
            <CardContent>
              {deployment ? (
                ...
                <div className="flex flex-col items-center justify-center py-12 text-center">
                  ...
                  <p className="text-sm text-muted-foreground">
                    This merchant doesn&apos;t have a deployment configured
                  </p>
                  <Link href="/admin/simulate">
            ...
            <CardContent>
              {database ? (
                ...
                <div className="flex flex-col items-center justify-center py-12 text-center">
                  ...
                  <p className="text-sm text-muted-foreground">
                    This merchant doesn&apos;t have a database configured
                  </p>
                  <Link href="/admin/simulate">
            ...
            <CardContent>
              {merchant.settings ? (
                <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
                  <InfoItem
                    label="Brand Name"
                    value={merchant.settings.brandName}
                    icon={Building2}
                  />
                  <InfoItem
                    label="Currency"
                    value={merchant.settings.currency}
                    icon={DollarSign}
                  />
                  <InfoItem
                    label="Timezone"
                    value={merchant.settings.timezone}
                    icon={Clock}
                  />
                ...
                <div className="flex flex-col items-center justify-center py-12 text-center">
                  ...
                  <p className="text-sm text-muted-foreground">
                    This merchant hasn&apos;t configured any settings yet
                  </p>
                </div>
              )}
            </CardContent>
