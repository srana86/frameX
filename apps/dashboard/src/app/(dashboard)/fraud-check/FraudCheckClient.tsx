...
import { Search, Shield, TrendingUp, Package, CheckCircle2, XCircle, AlertTriangle, Calendar, Truck, Activity, Info } from "lucide-react";
import type { CustomerFraudData, UsageStats } from "@/lib/fraud-check/fraudshield-api";
  ...
  const handleCheck = async () => {
    ...
    try {
      ...
      if (data.status === "success" && data.courierData) {
        ...
        // Handle old API response structure (backward compatibility)
