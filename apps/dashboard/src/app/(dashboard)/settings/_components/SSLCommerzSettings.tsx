...
export function SSLCommerzSettings() {
  const [config, setConfig] = useState<SSLCommerzConfig>(defaultSSLCommerzConfig);
  ...
  const testConnection = async () => {
    ...
    try {
      const res = await fetch("/api/settings/sslcommerz/test", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({
      ...
      if (res.ok && data.success) {
        ...
        setTestResult({
          success: false,
          message: data.message || "Connection test failed. Please check your credentials.",
        });
    ...
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Configure your SSLCommerz payment gateway credentials. Get your credentials from{" "}
            <a
        ...
        <CardContent className="space-y-6">
          ...
          {config.isLive && (
            <Alert variant="destructive">
              ...
              <AlertDescription>
                Real payments will be processed. Make sure your credentials are correct.
              </AlertDescription>
            </Alert>
          )}
        ...
        <CardContent className="space-y-4">
          <div className="space-y-2">
            ...
            <div className="flex items-center gap-2">
              <Input
                readOnly
                value={`${typeof window !== "undefined" ? window.location.origin : ""}/api/checkout/ipn`}
            ...
            <p className="text-xs text-muted-foreground">
              Set this URL in your SSLCommerz merchant panel for payment verification
            </p>
          </div>
          ...
          <div className="grid gap-3 sm:grid-cols-3">
            ...
            >
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground">Manage active subscriptions</p>
              </div>
            </a>
            <a
              href="/payments"
