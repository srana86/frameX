...
export function AdminShell({ children }: { children: React.ReactNode }) {
  ...
  useEffect(() => {
    ...
    } else if (role === "OWNER" || role === "TENANT" || role === "STAFF") {
      // OWNER, TENANT (store admin), and STAFF go to owner panel
      window.location.href = process.env.NEXT_PUBLIC_LANDING_URL || "http://localhost:3001/owner";
    } else {
