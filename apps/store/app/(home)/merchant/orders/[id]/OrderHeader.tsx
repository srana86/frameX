    ...
    <div className='bg-background/95 backdrop-blur-xl border-b border-primary/10 sticky top-0 z-40'>
      <div className='w-full'>
        ...
        <div className='hidden sm:flex items-center gap-1.5 px-0 pt-3 pb-1 text-xs'>
          <Link href='/merchant' className='text-muted-foreground hover:text-foreground transition-colors duration-200'>
            Dashboard
          </Link>
          <ChevronRight className='h-3 w-3 text-muted-foreground/50' />
          <Link href='/merchant/orders' className='text-muted-foreground hover:text-foreground transition-colors duration-200'>
            Orders
          </Link>
          <ChevronRight className='h-3 w-3 text-muted-foreground/50' />
            ...
            <div className='hidden sm:flex items-center gap-1.5 sm:gap-2'>
              ...
              <div className='hidden md:flex items-center gap-1 mr-2'>
                <Button
                  ...
                  onClick={() => prevOrderId && router.push(`/merchant/orders/${prevOrderId}`)}
                ...
                <Button
                  ...
                  onClick={() => nextOrderId && router.push(`/merchant/orders/${nextOrderId}`)}
