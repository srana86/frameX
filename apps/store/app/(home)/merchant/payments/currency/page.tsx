...
import { BrandConfigClient } from "@/app/(home)/merchant/brand/BrandConfigClient";
import { loadBrandConfig } from "@/app/(home)/merchant/brand/loadBrandConfig";
    ...
    <div className='mx-auto w-full space-y-4'>
      <div className='flex items-center justify-between gap-3 pt-4'>
        ...
        <Button asChild variant='outline' size='sm'>
          <Link href='/merchant/payments' className='flex items-center gap-2'>
