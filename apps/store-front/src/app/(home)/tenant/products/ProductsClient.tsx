                ...
                >
                  ...
                  <div className='relative w-full aspect-square overflow-hidden bg-slate-100 dark:bg-slate-800'>
                    ...
                    <div className='absolute top-2 right-2 flex gap-1.5 opacity-0 group-hover:opacity-100 transition-opacity'>
                      ...
                      >
                        <Link href={`/tenant/products/${encodeURIComponent(isObjectId(p.id) ? p.id : p.slug)}/edit`}>Edit</Link>
                      </Button>
                      <AlertDialog>
                      ...
                      <TableCell className='p-2 sm:p-4'>
                        <div className='flex justify-end gap-1.5 sm:gap-2'>
                          <Button asChild variant='outline' size='sm' className='h-7 sm:h-8 px-2 sm:px-3 text-xs'>
                            <Link href={`/tenant/products/${encodeURIComponent(isObjectId(p.id) ? p.id : p.slug)}/edit`}>
