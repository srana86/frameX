                  ...
                  <TableBody>
                    {payments.map((payment) => (
                      <TableRow key={payment._id || payment.transactionId} className='hover:bg-accent/50'>
                        <TableCell>
                          <div className='flex flex-col gap-1'>
                            ...
                            <div className='flex items-center gap-2 text-xs text-muted-foreground sm:hidden'>
                              <Link href={`/tenant/orders/${payment.orderId}`} className='text-primary hover:underline font-mono'>
                        ...
                        <TableCell className='hidden sm:table-cell'>
                          <Link href={`/tenant/orders/${payment.orderId}`} className='text-primary hover:underline font-mono text-sm'>
