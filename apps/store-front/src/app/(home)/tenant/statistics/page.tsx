...
async function getStatisticsData() {
  try {
    ...
    const paymentsCol = await getTenantCollectionForAPI("payment_transactions");
    const productsCol = await getTenantCollectionForAPI("products");
    const categoriesCol = await getTenantCollectionForAPI("product_categories");
    const inventoryCol = await getTenantCollectionForAPI("inventory");
